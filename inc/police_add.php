...
try {
	...
	if($user->level<$config['permissions']['createUser']) throw new Exception(NO_PERMISSION);
	...
	$sql = "INSERT INTO `lspd_users` (`name`, `surname`, `login`, `password`, `level`) VALUES ('$name', '$surname', '$login', '$password', '$level')";
	if($db->query($sql)) {
